            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="page_content pb-16">
                        ...
                        <img src="<?= domain ?>assets/img/delete_kalite_img.webp" alt="Kalite Görsel">
                        <p>
                    ...
                    <aside class="relative after-absolute w-full pr-3 flex flex-col justify-end">
                        ...
                        <div class="flex flex-col items-end pr-6">
                            <a href="kalitepolitikamiz.php"
                                class="inline-block text-end font-semibold text-iki-base text-black leading-normal py-3">Kalite Politikamız</a>
                            <a href="belgelerimiz.php"
